use crate::testing::culling::geodesy::{dvec3_to_lat_lon, intersect_ellipsoid, tile_contains};
...
fn evaluate_direct_camera(file: &mut std::fs::File, z: f32) {
    ...
    let results: Vec<Result<TileId, ()>> = points
        .par_iter()
        .filter_map(|&(x, y)| {
    ...
    writeln!(
        file,
        "{},{},{},{},{}",
        z, rendered_tiles, hit_tiles, false_positives, false_negatives
    )
    .unwrap();
}
