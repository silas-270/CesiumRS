#[cfg(test)]
mod tests {
    use cesium_engine::globe::tiles::tile_fetcher::{TilePriority, TileFetcher};
    ...
    fn test_fetch_valid_tile() {
        ...
        let fetcher = TileFetcher::new(tx, "https://a.basemaps.cartocdn.com/dark_nolabels/{z}/{x}/{y}.png".to_string(), false);
